...
raw_data = load_dataset('kde4',lang1="en", lang2="fr")['train'].select(range(40000,50000))
...
model1 = HookedTransformer.from_pretrained("phi-1")
cg=model1.cfg.to_dict()
model = HookedTransformer(cg)
model.load_state_dict(torch.load("/home/ubuntu/model_2000.pt", map_location=model.cfg.device))
