...
model.load_state_dict(torch.load("Yelp_v1.pt", map_location=model.cfg.device))
...
cfg=HookedTransformerTrainConfig(num_epochs=10, batch_size=20,save_every=500,warmup_steps=2000,max_grad_norm=1.0, lr=0.001, seed=0, momentum=0.0, weight_decay=0.01, optimizer_name='AdamW', device=device1,save_dir="/home/ubuntu/")
